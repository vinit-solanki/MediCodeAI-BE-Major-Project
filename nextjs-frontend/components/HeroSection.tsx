...
const HeroSection = () => {
  return (
    <section className="relative py-12 px-4 sm:py-14 lg:py-16 xl:py-20 bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="space-y-4 text-center lg:text-left">
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-5xl lg:text-4xl xl:text-5xl font-extrabold leading-tight">
        ...
        <div className="relative mt-12 lg:mt-0">
          ...
          <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 lg:p-6 shadow-xl border border-gray-200">
            ...
            <div className="text-2xl lg:text-3xl font-bold text-green-600">99.7%</div>
          </div>
          ...
          <div className="absolute -top-6 -right-6 bg-white rounded-2xl p-4 lg:p-6 shadow-xl border border-gray-200">
            ...
            <div className="text-2xl lg:text-3xl font-bold text-indigo-600">3x Faster</div>
          </div>
        </div>
      </div>
    </section>
